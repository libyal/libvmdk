...
{
	static char *function = "pyvmdk_file_object_io_handle_initialize";
	...
	*file_object_io_handle = (pyvmdk_file_object_io_handle_t *) PyMem_Malloc(
	                                                             sizeof( pyvmdk_file_object_io_handle_t ) );
	...
	if( memory_set(
	     *file_object_io_handle,
	     0,
	     sizeof( pyvmdk_file_object_io_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int pyvmdk_file_object_initialize(
     ...
     libcerror_error_t **error )
{
	pyvmdk_file_object_io_handle_t *file_object_io_handle = NULL;
	static char *function                                 = "pyvmdk_file_object_initialize";
	...
	if( pyvmdk_file_object_io_handle_initialize(
	     &file_object_io_handle,
	     file_object,
	     error ) != 1 )
	{
	...
	if( libbfio_handle_initialize(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) pyvmdk_file_object_io_handle_free,
	     (int (*)(intptr_t **, intptr_t *, libcerror_error_t **)) pyvmdk_file_object_io_handle_clone,
	     (int (*)(intptr_t *, int, libcerror_error_t **)) pyvmdk_file_object_io_handle_open,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyvmdk_file_object_io_handle_close,
	     (ssize_t (*)(intptr_t *, uint8_t *, size_t, libcerror_error_t **)) pyvmdk_file_object_io_handle_read,
	     (ssize_t (*)(intptr_t *, const uint8_t *, size_t, libcerror_error_t **)) pyvmdk_file_object_io_handle_write,
	     (off64_t (*)(intptr_t *, off64_t, int, libcerror_error_t **)) pyvmdk_file_object_io_handle_seek_offset,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyvmdk_file_object_io_handle_exists,
	     (int (*)(intptr_t *, libcerror_error_t **)) pyvmdk_file_object_io_handle_is_open,
	     (int (*)(intptr_t *, size64_t *, libcerror_error_t **)) pyvmdk_file_object_io_handle_get_size,
...
on_error:
	if( file_object_io_handle != NULL )
	{
		pyvmdk_file_object_io_handle_free(
		 &file_object_io_handle,
		 NULL );
	}
	return( -1 );
...
int pyvmdk_file_object_io_handle_clone(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyvmdk_file_object_io_handle_clone";
...
int pyvmdk_file_object_io_handle_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyvmdk_file_object_io_handle_open";
...
int pyvmdk_file_object_io_handle_close(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyvmdk_file_object_io_handle_close";
         ...
         libcerror_error_t **error )
{
	...
	static char *function      = "pyvmdk_file_object_read_buffer";
...
ssize_t pyvmdk_file_object_io_handle_read(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyvmdk_file_object_io_handle_read";
	PyGILState_STATE gil_state = 0;
	ssize_t read_count         = 0;
	...
	read_count = pyvmdk_file_object_read_buffer(
	              file_object_io_handle->file_object,
	              buffer,
	              size,
	              error );
...
ssize_t pyvmdk_file_object_io_handle_write(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyvmdk_file_object_io_handle_write";
	PyGILState_STATE gil_state = 0;
	...
	write_count = pyvmdk_file_object_write_buffer(
	               file_object_io_handle->file_object,
	               buffer,
	               size,
	               error );
     ...
     libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pyvmdk_file_object_seek_offset";
...
off64_t pyvmdk_file_object_io_handle_seek_offset(
         ...
         libcerror_error_t **error )
{
	static char *function      = "pyvmdk_file_object_io_handle_seek_offset";
	PyGILState_STATE gil_state = 0;
	...
	if( pyvmdk_file_object_seek_offset(
	     file_object_io_handle->file_object,
	     offset,
	     whence,
	     error ) != 1 )
	...
	if( pyvmdk_file_object_get_offset(
	     file_object_io_handle->file_object,
	     &offset,
	     error ) != 1 )
	{
...
int pyvmdk_file_object_io_handle_exists(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyvmdk_file_object_io_handle_exists";
...
int pyvmdk_file_object_io_handle_is_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "pyvmdk_file_object_io_handle_is_open";
...
{
	PyObject *method_name      = NULL;
	static char *function      = "pyvmdk_file_object_io_handle_get_size";
	PyGILState_STATE gil_state = 0;
	...
	if( result != 0 )
	{
		if( pyvmdk_file_object_get_size(
		     file_object_io_handle->file_object,
		     size,
		     error ) != 1 )
		{
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			...
			pyvmdk_file_object_seek_offset(
			 file_object_io_handle->file_object,
			 current_offset,
			 SEEK_SET,
			 NULL );
