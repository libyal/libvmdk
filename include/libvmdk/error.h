...
enum LIBVMDK_ARGUMENT_ERROR
{
	 ...
	 */
	LIBVMDK_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
enum LIBVMDK_COMPRESSION_ERROR
{
	 ...
	 */
	LIBVMDK_COMPRESSION_ERROR_UNCOMPRESS_FAILED   = 2
};
...
enum LIBVMDK_INPUT_ERROR
{
	 ...
	 */
	LIBVMDK_INPUT_ERROR_CRC_MISMATCH              = 3,
	 ...
	 */
	LIBVMDK_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBVMDK_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBVMDK_RUNTIME_ERROR
{
	 ...
	 */
	LIBVMDK_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,
