...
{
	static char *function = "libvmdk_array_initialize";
	...
	if( *array == NULL )
	{
		*array = (libvmdk_array_t *) memory_allocate(
		                              sizeof( libvmdk_array_t ) );
...
int libvmdk_array_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_array_free";
     ...
     liberror_error_t **error )
{
	...
	static char *function = "libvmdk_array_resize";
	size_t entries_size   = 0;
...
int libvmdk_array_get_amount_of_entries(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_array_get_amount_of_entries";
...
int libvmdk_array_get_entry(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_array_get_entry";
...
int libvmdk_array_set_entry(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_array_set_entry";
...
int libvmdk_array_append_entry(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_array_append_entry";
