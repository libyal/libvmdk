...
{
	static char *function = "libvmdk_list_element_initialize";
	...
	if( *list_element == NULL )
	{
		*list_element = (libvmdk_list_element_t *) memory_allocate(
		                                            sizeof( libvmdk_list_element_t ) );
		...
		if( memory_set(
		     *list_element,
		     0,
		     sizeof( libvmdk_list_element_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libvmdk_list_element_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_element_free";
	int result            = 1;
...
int libvmdk_list_initialize(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_initialize";
	...
	if( *list == NULL )
	{
		*list = (libvmdk_list_t *) memory_allocate(
		                            sizeof( libvmdk_list_t ) );
...
int libvmdk_list_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_free";
	int result            = 0;
...
int libvmdk_list_empty(
     ...
     liberror_error_t **error )
{
	libvmdk_list_element_t *list_element = NULL;
	static char *function                = "libvmdk_list_empty";
...
int libvmdk_list_clone(
     ...
     liberror_error_t **error )
{
	libvmdk_list_element_t *source_list_element = NULL;
	intptr_t *destination_value                 = NULL;
	static char *function                       = "libvmdk_list_clone";
	int iterator                                = 0;
	...
	{
		*destination = (libvmdk_list_t *) memory_allocate(
		                                   sizeof( libvmdk_list_t ) );
...
int libvmdk_list_get_amount_of_elements(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_get_amount_of_elements";
...
{
	libvmdk_list_element_t *list_element = NULL;
	static char *function                = "libvmdk_list_get_element";
	int iterator                         = 0;
...
{
	libvmdk_list_element_t *list_element = NULL;
	static char *function                = "libvmdk_list_get_value";
	int result                           = 0;
	...
	result = libvmdk_list_get_element(
	          list,
	          element_index,
	          &list_element,
	          error );
...
int libvmdk_list_prepend_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_prepend_element";
...
int libvmdk_list_prepend_value(
     ...
     liberror_error_t **error )
{
	libvmdk_list_element_t *element = NULL;
	static char *function           = "libvmdk_list_prepend_value";
	...
	element = (libvmdk_list_element_t *) memory_allocate(
	                                      sizeof( libvmdk_list_element_t ) );
	...
	if( libvmdk_list_prepend_element(
	     list,
	     element,
	     error ) != 1 )
	{
...
int libvmdk_list_append_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_append_element";
...
{
	libvmdk_list_element_t *element = NULL;
	static char *function           = "libvmdk_list_append_value";
	...
	if( libvmdk_list_append_element(
	     list,
	     element,
	     error ) != 1 )
	{
...
{
	libvmdk_list_element_t *list_element = NULL;
	static char *function                = "libvmdk_list_insert_element";
	int result                           = 0;
	int iterator                         = 0;
	...
	else
	{
		     ...
		     iterator++ )
		{
			...
			else if( result == LIBVMDK_LIST_COMPARE_EQUAL )
			{
				return( 0 );
			}
			else if( result == LIBVMDK_LIST_COMPARE_LESS )
			{
...
{
	libvmdk_list_element_t *element = NULL;
	static char *function           = "libvmdk_list_insert_value";
	int result                      = 0;
	...
	result = libvmdk_list_insert_element(
	          list,
	          element,
...
int libvmdk_list_remove_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_list_remove_element";
