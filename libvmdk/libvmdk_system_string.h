...
#if !defined( _LIBVMDK_SYSTEM_STRING_H )
#define _LIBVMDK_SYSTEM_STRING_H
...
int libvmdk_system_string_size_from_narrow_string(
...
int libvmdk_system_string_size_from_wide_string(
...
#endif /* !defined( _LIBVMDK_SYSTEM_STRING_H ) */
