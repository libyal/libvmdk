...
{
	static char *function           = "libvmdk_values_table_initialize";
	...
	if( *values_table == NULL )
	{
		...
		*values_table = (libvmdk_values_table_t *) memory_allocate(
		                                            sizeof( libvmdk_values_table_t ) );
		...
		if( memory_set(
		     *values_table,
		     0,
		     sizeof( libvmdk_values_table_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libvmdk_values_table_free(
     ...
     liberror_error_t **error )
{
	static char *function     = "libvmdk_values_table_free";
...
int libvmdk_values_table_resize(
     ...
     liberror_error_t **error )
{
	static char *function           = "libvmdk_values_table_resize";
...
int libvmdk_values_table_get_amount_of_values(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_values_table_get_amount_of_values";
...
int libvmdk_values_table_get_index(
     ...
     liberror_error_t **error )
{
	static char *function     = "libvmdk_values_table_get_index";
	int values_table_iterator = 0;
...
int libvmdk_values_table_get_identifier_size(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_values_table_get_identifier_size";
...
int libvmdk_values_table_get_identifier(
     ...
     liberror_error_t **error )
{
	static char *function           = "libvmdk_values_table_get_identifier";
	size_t internal_identifier_size = 0;
	...
	internal_identifier_size = values_table->identifier_length[ index ] + 1;

	if( identifier_size < internal_identifier_size )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
...
int libvmdk_values_table_set_identifier(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_values_table_set_identifier";
...
int libvmdk_values_table_get_value_size(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_values_table_get_value_size";
	int index             = 0;
	int result            = 0;
	...
	result = libvmdk_values_table_get_index(
	          values_table,
	          identifier,
	          identifier_length,
	          &index,
...
int libvmdk_values_table_get_value(
     ...
     liberror_error_t **error )
{
	static char *function      = "libvmdk_values_table_get_value";
	size_t internal_value_size = 0;
	int index                  = 0;
	int result                 = 0;
	...
	internal_value_size = values_table->value_length[ index ] + 1;

	if( value_size < internal_value_size )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
...
int libvmdk_values_table_set_value(
     ...
     liberror_error_t **error )
{
	static char *function = "libvmdk_values_table_set_value";
	int index             = 0;
	int result            = 0;
	...
	else if( result == 0 )
	{
		...
		if( libvmdk_values_table_resize(
		     values_table,
		     index + 1,
		     error ) != 1 )
		{
		...
		if( libvmdk_values_table_set_identifier(
		     values_table,
		     index,
		     identifier,
		     identifier_length,
