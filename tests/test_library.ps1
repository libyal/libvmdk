...
$LibraryTests = "deflate descriptor_file error extent_descriptor extent_file extent_table grain_data grain_group grain_table io_handle notify"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\vmdk_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libvmdk"
