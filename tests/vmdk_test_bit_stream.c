...
#include "../libvmdk/libvmdk_bit_stream.h"

/* Define to make vmdk_test_bit_stream generate verbose output
#define VMDK_TEST_BIT_STREAM_VERBOSE
 */

uint8_t vmdk_test_bit_stream_data[ 16 ] = {
...
/* Tests the libvmdk_bit_stream_initialize function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_bit_stream_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libvmdk_bit_stream_initialize(
	          &bit_stream,
	          vmdk_test_bit_stream_data,
	          16,
	          0,
	...
	result = libvmdk_bit_stream_free(
	          &bit_stream,
	          &error );
	...
	bit_stream = (libvmdk_bit_stream_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvmdk_bit_stream_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvmdk_bit_stream_initialize with memset failing
		 */
...
/* Tests the libvmdk_bit_stream_free function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_bit_stream_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libvmdk_bit_stream_get_value function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_bit_stream_get_value(
     void )
{
	libcerror_error_t *error         = NULL;
	libvmdk_bit_stream_t *bit_stream = NULL;
	...
	/* Test regular cases
	 */
	result = libvmdk_bit_stream_get_value(
	          bit_stream,
	          0,
	          &value_32bit,
	          &error );
...
#endif
{
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( VMDK_TEST_BIT_STREAM_VERBOSE )
	...
	VMDK_TEST_RUN(
	 "libvmdk_bit_stream_initialize",
	 vmdk_test_bit_stream_initialize );

	VMDK_TEST_RUN(
	 "libvmdk_bit_stream_free",
	 vmdk_test_bit_stream_free );

	VMDK_TEST_RUN(
	 "libvmdk_bit_stream_get_value",
	 vmdk_test_bit_stream_get_value );
