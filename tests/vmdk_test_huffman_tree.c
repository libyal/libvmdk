...
uint8_t vmdk_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the libvmdk_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_huffman_tree_initialize(
     void )
{
	libcerror_error_t *error             = NULL;
	libvmdk_huffman_tree_t *huffman_tree = NULL;
	int result                           = 0;
	...
	huffman_tree = (libvmdk_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvmdk_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvmdk_huffman_tree_initialize with memset failing
		 */
...
/* Tests the libvmdk_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libvmdk_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = libvmdk_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test libvmdk_huffman_tree_build with malloc failing
	 */
	...
	/* Test libvmdk_huffman_tree_build with memset failing
	 */
...
/* Tests the libvmdk_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int vmdk_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = libvmdk_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
...
#endif
{
	...
	VMDK_TEST_RUN(
	 "libvmdk_huffman_tree_initialize",
	 vmdk_test_huffman_tree_initialize );

	VMDK_TEST_RUN(
	 "libvmdk_huffman_tree_free",
	 vmdk_test_huffman_tree_free );

	VMDK_TEST_RUN(
	 "libvmdk_huffman_tree_build",
	 vmdk_test_huffman_tree_build );

	VMDK_TEST_RUN(
	 "libvmdk_huffman_tree_get_symbol_from_bit_stream",
	 vmdk_test_huffman_tree_get_symbol_from_bit_stream );
