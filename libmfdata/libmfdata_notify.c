...
{
	static char *function = "libmfdata_notify_set_stream";
...
int libmfdata_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libmfdata_notify_stream_open";
...
int libmfdata_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libmfdata_notify_stream_close";
