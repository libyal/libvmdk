...
#if !defined( _LIBMFDATA_ARRAY_TYPE_H )
#define _LIBMFDATA_ARRAY_TYPE_H
 ...
 */
enum LIBMFDATA_ARRAY_COMPARE_DEFINITIONS
{
	/* The first value is less than the second value
	 */
        LIBMFDATA_ARRAY_COMPARE_LESS,

	/* The first and second values are equal
	 */
        LIBMFDATA_ARRAY_COMPARE_EQUAL,

	/* The first value is greater than the second value
	 */
        LIBMFDATA_ARRAY_COMPARE_GREATER
};

/* The array insert flag definitions
 */
enum LIBMFDATA_ARRAY_INSERT_FLAGS
{
	/* Allow duplicate entries
	 */
	LIBMFDATA_ARRAY_INSERT_FLAG_NON_UNIQUE_ENTRIES	= 0x00,

	/* Only allow unique entries, no duplicates
	 */
	LIBMFDATA_ARRAY_INSERT_FLAG_UNIQUE_ENTRIES	= 0x01,
};
