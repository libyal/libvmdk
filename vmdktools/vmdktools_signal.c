...
void (*vmdktools_signal_signal_handler)( vmdktools_signal_t ) = NULL;
...
{
	static char *function = "vmdktools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( vmdktools_signal_signal_handler != NULL )
			{
				vmdktools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "vmdktools_signal_attach";
	...
	vmdktools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) vmdktools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	vmdktools_signal_initialize_memory_debug();
#endif
...
int vmdktools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "vmdktools_signal_detach";
	...
	vmdktools_signal_signal_handler = NULL;
