...
#if !defined( _VMDKTOOLS_GETOPT_H )
#define _VMDKTOOLS_GETOPT_H
...
typedef struct vmdktools_option vmdktools_option_t;

struct vmdktools_option
{
...
#define vmdktools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vmdktools_getopt(
                  int argument_count,
...
void vmdktools_getopt_wrapped_fprint(
      FILE *stream,
...
void vmdktools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vmdktools_option_t *options,
      int number_of_options );

int vmdktools_getopt_get_options_string(
     const vmdktools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VMDKTOOLS_GETOPT_H ) */
