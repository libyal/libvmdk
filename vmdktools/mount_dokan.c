...
extern mount_handle_t *vmdkmount_mount_handle;
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context VMDKTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes VMDKTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access VMDKTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options VMDKTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	VMDKTOOLS_UNREFERENCED_PARAMETER( security_context )
	VMDKTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	VMDKTOOLS_UNREFERENCED_PARAMETER( share_access )
	VMDKTOOLS_UNREFERENCED_PARAMETER( creation_options )
